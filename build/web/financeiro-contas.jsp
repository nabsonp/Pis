...
<html>
    ...
    <body>
        ...
        <div id = "navega">
            <span class = "navegacao"><a href = "Home.jsp">Página Inicial</a> » <a href = "AbrirFinanInsumos">Finaneiro</a> » <span id = "atual">Contas coletivas da fazenda</span></span>
        </div>
        ...
        <div id = "corpo">
            ...
            <div id = "tituloETabela">
                ...
                <table class = "contas">
                    <thead> 
                        <tr><th> Nº </th> <th> Conta </th> <th>Fornecedor</th> <th> Valor(R$) </th> </tr> 
                    </thead> 
                    <tbody> 
                        <%
