...
<html>
    <head>
        ...
        <title>Selecionar Espécie</title>
        ...
        <script src="js/escolher-especie.js" type = "text/javascript"></script>
    </head>
    <body>
        <nav id = "menu">
            <ul>
        ...
        <div id = "navega"><a href = "Home.jsp">Página Inicial</a> &raquo; <a href = "AbrirTanques">Tanques</a> &raquo; <a href = "AbrirTanque?tanque=<%=idTanque%>">Tanque <%= idTanque %></a> &raquo; <span id = "atual">Selecionar Espécie</span></div>
            ...
            <%
                ...
                for (Especie e : esps) {
                    out.println("<div class = \"especieIndividual\">"
                            + "<span class = \"dados\" onclick = \"confirmar('" + e.getId() + "', '" + request.getAttribute("idTanque") +"')\">"
                            + "<img src = \"" + e.getImagem() + "\" />"
