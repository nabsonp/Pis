<%-- 
    Document   : rel-tanque-biometrico
    Created on : 08/12/2017, 23:46:57
    Author     : samsung
--%>
...
<html>
    <head>
        ...
        <title>Relatório Biométrico</title>
        ...
        <script src="js/rel-tanque-biometrico.js"></script>
    ...
    <body>
        ...
        <div id = "navega"><a href = "Home.jsp">Página Inicial</a> &raquo; <a href = "escolher-periodo.jsp">Período</a> &raquo; <span id = "atual">Relatórios Biométricos do Tanque <%= id%></span></div>
        ...
        <div id = "corpo">
            ...
            <nav id = "submenuTanque">
                <ul>
                    <li class = "current"><button onclick = "abrirTanqueBiometrico(<%=id%>)">Biometria</button></li>
                    <li><button onclick = "abrirAgua(<%=id%>)">Água</button></li>
                </ul>
            </nav>
            <%
